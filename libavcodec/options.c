...
{"b", "set bitrate (in bits/s)", OFFSET(bit_rate), FF_OPT_TYPE_INT64, AV_CODEC_DEFAULT_BITRATE, 0, INT_MAX, V|E},
{"vb", "set bitrate (in bits/s)", OFFSET(bit_rate), FF_OPT_TYPE_INT64, AV_CODEC_DEFAULT_BITRATE, 0, INT_MAX, V|E},
{"ab", "set bitrate (in bits/s)", OFFSET(bit_rate), FF_OPT_TYPE_INT64, 64*1000, 0, INT_MAX, A|E},
...
{"maxrate", "set max video bitrate tolerance (in bits/s)", OFFSET(rc_max_rate), FF_OPT_TYPE_INT, DEFAULT, 0, INT_MAX, V|E},
{"minrate", "set min video bitrate tolerance (in bits/s)", OFFSET(rc_min_rate), FF_OPT_TYPE_INT, DEFAULT, 0, INT_MAX, V|E},
{"bufsize", "set ratecontrol buffer size (in bits)", OFFSET(rc_buffer_size), FF_OPT_TYPE_INT, DEFAULT, 0, INT_MAX, A|V|E},
...
{"flags2", NULL, OFFSET(flags2), FF_OPT_TYPE_FLAGS, CODEC_FLAG2_BIT_RESERVOIR, 0, UINT_MAX, V|A|E|D, "flags2"},
...
{"profile", NULL, OFFSET(profile), FF_OPT_TYPE_INT, FF_PROFILE_UNKNOWN, INT_MIN, INT_MAX, V|E, "profile"},
{"aprofile", NULL, OFFSET(profile), FF_OPT_TYPE_INT, FF_PROFILE_UNKNOWN, INT_MIN, INT_MAX, A|E, "aprofile"},
{"level", NULL, OFFSET(level), FF_OPT_TYPE_INT, FF_LEVEL_UNKNOWN, INT_MIN, INT_MAX, V|E, "level"},
{"alevel", NULL, OFFSET(level), FF_OPT_TYPE_INT, FF_LEVEL_UNKNOWN, INT_MIN, INT_MAX, A|E, "alevel"},
...
{"color_primaries", NULL, OFFSET(color_primaries), FF_OPT_TYPE_INT, AVCOL_PRI_UNSPECIFIED, 1, AVCOL_PRI_NB-1, V|E|D, "color_primaries"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_PRI_BT709, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"bt470bg", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_PRI_BT470BG, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"smpte170m", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_PRI_SMPTE170M, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"color_transfer", NULL, OFFSET(color_transfer), FF_OPT_TYPE_INT, AVCOL_TRC_UNSPECIFIED, 1, AVCOL_TRC_NB-1, V|E|D, "color_transfer"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_TRC_BT709, INT_MIN, INT_MAX, V|E, "color_transfer"},
{"color_matrix", NULL, OFFSET(color_matrix), FF_OPT_TYPE_INT, AVCOL_MTX_UNSPECIFIED, 1, AVCOL_MTX_NB-1, V|E|D, "color_matrix"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_MTX_BT709, INT_MIN, INT_MAX, V|E, "color_matrix"},
{"smpte170m", NULL, 0, FF_OPT_TYPE_CONST, AVCOL_MTX_SMPTE170M, INT_MIN, INT_MAX, V|E, "color_matrix"},
