...
static const AVOption options[] = {
    { "sws_flags", "scaler/cpu flags", OFFSET(flags), FF_OPT_TYPE_FLAGS, SWS_BICUBIC, 0, UINT_MAX, VE, "sws_flags" },
    ...
    { "color_primaries", "", OFFSET(color_primaries), FF_OPT_TYPE_INT, SWS_CS_DEFAULT, 1, 7, VE, "color_primaries" },
    { "bt709", "", 0, FF_OPT_TYPE_CONST, SWS_CS_ITU709, 0, 0, VE, "color_primaries" },
    { "bt470bg", "", 0, FF_OPT_TYPE_CONST, SWS_CS_ITU601, 0, 0, VE, "color_primaries" },
    { "smpte170m", "", 0, FF_OPT_TYPE_CONST, SWS_CS_ITU601, 0, 0, VE, "color_primaries" },
