...
int sws_init_context(SwsContext *c, SwsFilter *srcFilter, SwsFilter *dstFilter)
{
    ...
    sws_setColorspaceDetails(c, sws_getCoefficients(c->color_primaries), c->srcRange,
                             sws_getCoefficients(c->color_primaries), c->dstRange,
                             0, 1<<16, 1<<16);
...
// can't downscale !!!
    ...
    if (flags&SWS_PRINT_INFO) {
        ...
        switch (c->color_primaries) {
        case SWS_CS_ITU709:
            av_log(c, AV_LOG_INFO, "color primaries: bt709\n");
            break;
        }
    }
                           ...
                           SwsFilter *srcFilter, SwsFilter *dstFilter, const double *param)
{
    ...
    c->color_primaries = SWS_CS_DEFAULT;
                                        ...
                                        SwsFilter *srcFilter, SwsFilter *dstFilter, const double *param)
{
    ...
    if (!context) {
        ...
        context->param[0]  = param[0];
        context->param[1]  = param[1];
        context->color_primaries = SWS_CS_DEFAULT;
